...
function Truck(
   ...
   this.specific = function (num) {
      return num > this.towingCapacity
...
const tow = myTruck.specific;
console.log(tow.call(myTruck, 8000));
// Викликаємо метод tow з вагою більшою за towingCapacity
console.log(tow.call(myTruck, 12000));
...
const carDrive = car.drive.bind(car);
